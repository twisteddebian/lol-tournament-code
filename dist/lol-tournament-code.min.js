...
!function(e){"use strict";function t(e){var t,i;return r.assertArgument(r.isObject(e),1,"Object"),r.assert(e.name,function(){throw new r.RequiredError("name")}),e.map=r.includes(s,r.toNumber(e.map))?e.map:11,e.type=r.includes(o,r.toNumber(e.type))?e.type:6,e.size=r.includes(a,r.toNumber(e.size))?e.size:5,e.spectators=r.includes(n,e.spectators)?e.spectators:"DROPINONLY",e.extra=e.extra||"",i=JSON.stringify({name:e.name,extra:e.extra,password:e.password,report:e.report}),i=new Buffer(i).toString("base64"),t="pvpnet://lol/customgame/joinorcreate/map"+e.map+"/pick"+e.type+"/team"+e.size+"/spec"+e.spectators+"/"+i}var r=e.XP||require("expandjs"),s=[1,2,3,4,8,10,11,12],o=[1,2,4,6],a=[1,2,3,4,5],n=["ALL","NONE","NONE","FRIENDS","DROPINONLY"];r.isBrowser()?(e.LoL=e.LoL||{},e.LoL.tournamentCode=t):module.exports=t}("undefined"!=typeof window?window:global);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer)

},{"buffer":3,"expandjs":1}]},{},[6])


//# sourceMappingURL=lol-tournament-code.min.map v1.2.2
